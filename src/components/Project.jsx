...
const Project = ({ title, timePeriod, link, technologiesUsed, about, pictureLink }) => {
    return (
        <div>
            ...
            <div className={"flex flex-col px-2 md:px-4 xl:px-0 gap-2 xl:gap-5 mx-auto my-8 mt-14 md:mt-8 xl:my-16 items-center justify-center"}>
                <article className={"prose dark:prose-invert stone prose-sm md:prose-base lg:prose-lg xl:prose-xl"}>
                    <h1 className="">{title}</h1>
                </article>
                <article className={"prose xl:mb-10 dark:prose-invert stone prose-sm md:prose-base lg:prose-lg xl:prose-xl"}>
                ...
                <article className={"prose dark:prose-invert stone prose-sm md:prose-base lg:prose-lg xl:prose-xl"}>
                    <a href={link} className={"text-blue-200 underline"}>Link to demo website</a>
