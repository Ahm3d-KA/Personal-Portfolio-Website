...
export const Navbar = () => {
    ...
    return (
        <div className="z-10 bg-transparent text-gray-500 h-[100px] max-w-[2000px] mx-auto flex justify-between items-center">

            <h1 className="text-2xl text-slate-100  lg:text-3xl font-bold primary-color ml-4 xl:ml-40">Ahmed K</h1>

            <ul className="hidden md:flex">
                
                <li className="p-2 lg:p-5"><a href="#home">Home</a></li>
                <li className="p-2 lg:p-5"><a href="#about">About</a></li>
                <li className="p-2 lg:p-5"><a href="#work">Work</a></li>
                <li className="p-2 lg:p-5"><a href="#experience">Experience</a></li>
                <li className="p-2 lg:p-5 pr-0 mr-4 xl:mr-40"><a href="#contact">Contact</a></li>
            </ul>
