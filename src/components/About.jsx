        ...
        <div id="about" className="py-10 text-white h-auto bg-[#232325]">
            ...
            md:gap-6 gap-12 px-10 max-w-6xl mx-auto">
                ...
                <div>
                    <div className="w-[400px] h-full">
                        <img
                            src={aboutImg}
                            alt="About image"
                            className="object-cover bg-gray-700 rounded-xl h-[300]px
                ...
                <div>
                    ...
                    <div className="lg:p-2">
                        <div className="lg:my-3">
                            <h3 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold mb-5">
                                About 
                                <span> </span>
                                <span className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold primary-text">
                                    <b>
                                        Me
                                    </b>
                                </span>
                            ...
                            <article className="prose dark:prose-invert prose-sm md:prose-base lg:prose-lg prose-stone">
                                <p className="hidden md:block">
                                    ...
                                    experiences. I
                                    thrive on solving complex problems and have a strong foundation in both front-end
                                    and
                                    back-end development.
                                </p>
                    ...
                    <div className="flex flex-col sm:flex-row mt-5 sm:mt-10 items-center gap-2 md:gap-5">

                        {/*Number of projects*/}
                        <div className="bg-[#333333]/40 p-3 rounded-lg w-full h-[120px]">
